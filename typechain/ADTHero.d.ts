...
interface ADTHeroInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "ChangeName(uint256,string)": EventFragment;
    "Minted(address,uint256,tuple)": EventFragment;
    ...
    "Sold(uint256,address,tuple,uint256)": EventFragment;
    "Transfer(address,address,uint256)": EventFragment;
    "UsedSignature(bytes)": EventFragment;
    "WithdrawRevenue(address,uint256)": EventFragment;
  };
...
export class ADTHero extends BaseContract {
  ...
  tokenIds(user: string, overrides?: CallOverrides): Promise<BigNumber[]>;
  ...
  filters: {
    ...
    Minted(
      ...
      ],
      {
        player: string;
        tokenId: BigNumber;
        info: [string, number, number, number, number] & {
          name: string;
          military: number;
          sex: number;
          army: number;
    ...
    Sold(
      ...
      ],
      {
        newItemId: BigNumber;
        player: string;
        hero: [string, number, number, number, number] & {
          name: string;
          military: number;
          sex: number;
          army: number;
    ...
    WithdrawRevenue(
      ...
      [string, BigNumber],
      { revenue: string; amount: BigNumber }
    >;
  };
