...
interface ArenaNFTInterface extends ethers.utils.Interface {
  functions: {
    ...
    "mintMany(address,string[])": FunctionFragment;
    "mintOne(address,string)": FunctionFragment;
...
export class ArenaNFT extends BaseContract {
  ...
  functions: {
    ...
    "mintOne(address,string)"(
      user: string,
      heroId: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    "mintOne(address,bytes)"(
      user: string,
      data: BytesLike,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  getInfo(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
